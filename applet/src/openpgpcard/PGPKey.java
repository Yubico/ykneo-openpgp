...
public class PGPKey implements ISO7816 {
     ...
     */
    public void setDP1(byte[] buffer, short offset, short length, byte[] tmpBuf) {
     ...
     * The length of the parameter
     */
    public void setDQ1(byte[] buffer, short offset, short length, byte[] tmpBuf) {
        Util.arrayFillNonAtomic(tmpBuf, (short) 0, (short) tmpBuf.length, (byte) 0);
        Util.arrayCopyNonAtomic(buffer, offset, tmpBuf, (short) (COMPONENT_BYTES - length), length);
     ...
     * The length of the parameter
     */
    public void setPQ(byte[] buffer, short offset, short length, byte[] tmpBuf) {
        Util.arrayFillNonAtomic(tmpBuf, (short) 0, (short) tmpBuf.length, (byte) 0);
        Util.arrayCopyNonAtomic(buffer, offset, tmpBuf, (short) (COMPONENT_BYTES - length), length);
